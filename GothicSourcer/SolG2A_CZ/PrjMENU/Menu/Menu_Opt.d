...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Grafický adaptér, rozlišení, jas a kontrast";
	posx = 0;
...
instance MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Hlasitost hudby, zvuku a mluvené øeèi";
	posx = 0;
...
instance MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Ovládání";
	text[1] = "Konfigurace klávesnice a myši";
	posx = 0;
...
instance MENUITEM_OPT_EXT(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Nìkterá další nastavení";
	posx = 0;
...
instance MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Optimalizace výkonu a kvality";
	posx = 0;
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0] = "Vlastní#Nejlepší výkon|Støední kvalita|Nejvyšší kvalita";
