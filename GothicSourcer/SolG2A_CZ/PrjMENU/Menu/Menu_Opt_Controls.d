...
instance MENU_ITEM_NEXTMENU(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Konfigurace dalších kláves";
...
{
	text[0] = "Levý útok";
	text[1] = "kláv. DEL uvolníš a pomocí ENTER znovu nadefinuješ";
	posx = CTRL_SP1_1;
...
instance MENU_ITEM_CHG_KEYS_SET_DEFAULT(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Nastavit ovládání zpìt na implicitní";
	posx = CTRL_SP1_1;
...
instance MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Nastavit ovládání na alternativní";
	posx = CTRL_SP1_1;
