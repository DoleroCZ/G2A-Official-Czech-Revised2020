...
instance MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Hlasitost ef.";
	text[1] = "Hlasitost zvukových efektù a øeèi";
	posx = 1000;
...
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Zap/vyp hudby";
	text[1] = "Zapíná a vypíná hudbu na pozadí";
	posx = 1000;
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Tyto úèinky se projeví až po restarování";
	posx = 1000;
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Ozvìna";
	text[1] = "Efekty ozvìny v jeskyních apod.";
	posx = 1000;
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Ozvìny øeèi";
	text[1] = "Chceš, aby ozvìna ovlivòovala i mluvené slovo?";
	posx = 1000;
