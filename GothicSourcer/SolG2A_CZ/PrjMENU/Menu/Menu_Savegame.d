...
instance MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0] = "neznámé";
	text[1] = "Pozice 1 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 2 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 3 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 4 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 5 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 6 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 7 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 8 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 9 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 10 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 11 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 12 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 13 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 14 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 15 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 16 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 17 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 18 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 19 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "neznámé";
	text[1] = "Pozice 20 - pro použití této pozice stisknìte ENTER a napište její název.";
	posx = SAVEGAME_X1;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 1 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (0 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 2 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (1 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 3 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (2 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 4 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (3 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 5 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (4 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 6 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (5 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "neznámé";
	text[1] = "Pozice 7 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (6 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 8 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (7 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 9 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (8 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 10 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (9 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 11 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (10 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 12 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (11 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 13 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (12 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 14 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (13 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 15 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (14 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 16 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (15 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 17 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (16 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 18 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (17 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 19 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (18 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Pozice 20 - klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (19 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
instance MENUITEM_LOAD_SLOT0(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Klávesou ENTER tuto hru naètete.";
	posx = SAVEGAME_X1;
