...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Dohled";
	text[1] = "Urèete míru dohledu (v procentech)";
	posx = 1000;
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Zvýr. objektù";
	text[1] = "Vzdálenost zobr. objektù";
	posx = 1000;
...
instance MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Ef. na obloze";
	text[1] = "Zapnout èi vypnout efekty na obloze";
	posx = 1000;
