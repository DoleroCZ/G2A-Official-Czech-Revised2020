...
instance ITMW_ADDON_STAB04(C_ITEM)
{
	...
	description = "Ultharova kouzeln· h˘l";
	text[2] = NAME_DAMAGE;
	count[2] = damagetotal;
	text[3] = NAME_STR_NEEDED;
	count[3] = cond_value[2];
...
instance ITMW_ADDON_BANDITTRADER(C_ITEM)
{
	...
	description = name;
	text[1] = "Na ka¯dÈm je vyryto pÌsmeno 'F'";
	text[2] = NAME_DAMAGE;
	count[2] = damagetotal;
