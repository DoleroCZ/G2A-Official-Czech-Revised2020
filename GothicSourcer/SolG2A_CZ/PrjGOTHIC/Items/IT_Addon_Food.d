...
instance ITFO_ADDON_SHELLFLESH(C_ITEM)
{
	...
	text[2] = "Nevaøené chutná výteènì.";
	text[3] = "";
	text[5] = NAME_VALUE;
	count[5] = value;
};
...
instance ITFO_ADDON_GROG(C_ITEM)
{
	...
	on_state[0] = usegrog;
	scemename = "POTIONFAST";
	description = "Pravý námoønický grog";
	text[1] = NAME_BONUS_HP;
	count[1] = HP_GROG;
	text[5] = NAME_VALUE;
	count[5] = VALUE_GROG;
...
instance ITFO_ADDON_SCHLAFHAMMER(C_ITEM)
{
	...
	text[1] = "Dìlá i z nejvìtších opilcù 'unavené' ...";
	text[5] = NAME_VALUE;
...
instance ITFO_ADDON_SCHNELLERHERING(C_ITEM)
{
	...
	scemename = "POTIONFAST";
	description = "Rychlý sleï";
	text[1] = "Vypadá nebezpeènì!";
	text[2] = "Efekt neznámý.";
	text[3] = "Èasté postraní efekty!";
	text[5] = NAME_VALUE;
