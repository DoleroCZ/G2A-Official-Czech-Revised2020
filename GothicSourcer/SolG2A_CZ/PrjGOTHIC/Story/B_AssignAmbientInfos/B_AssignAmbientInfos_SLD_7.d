...
instance DIA_SLD_7_LOCATION(C_INFO)
{
	...
	permanent = TRUE;
	description = "Øekni mi nìco o farmì.";
};
...
func void dia_sld_7_standard_info()
{
	...
	if(KAPITEL <= 2)
	{
		...
		{
			AI_Output(self,other,"DIA_SLD_7_STANDARD_07_05");	//Tvoji paladinové si nevìdí s draky rady? Takoví kašpaøi - boj je práce pro opravdové chlapy.
		};
	};
	if(KAPITEL == 3)
	{
