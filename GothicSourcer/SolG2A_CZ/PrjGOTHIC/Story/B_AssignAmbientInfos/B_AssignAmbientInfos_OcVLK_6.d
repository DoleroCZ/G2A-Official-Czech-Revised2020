...
func void dia_ocvlk_6_people_info()
{
	...
	{
		AI_Output(self,other,"DIA_OCVLK_6_PEOPLE_06_03");	//Pokud chceš nìjaké vybavení, mìl bys zajít za Engorem. Najdeš ho v domku naproti Garondovi.
	};
};
...
func void dia_ocvlk_6_location_info()
{
	...
	AI_Output(self,other,"DIA_OCVLK_6_LOCATION_06_04");	//Za tou zdí se rozprostírá moøe. Pokud ještì pøiplujou další lodì se skøety na palubì, nebudeme mít žádnou šanci.
};
...
func void dia_ocvlk_6_standard_info()
{
	...
	if(KAPITEL >= 5)
	{
		...
		{
			AI_Output(self,other,"DIA_OCVLK_6_STANDARD_06_06");	//Tahle zpropadená ruda. Mìli bysme ji všechnu shodit dolù z cimbuøí. Pak by nás skøeti možná nechali na pokoji.
		}
		else
		{
