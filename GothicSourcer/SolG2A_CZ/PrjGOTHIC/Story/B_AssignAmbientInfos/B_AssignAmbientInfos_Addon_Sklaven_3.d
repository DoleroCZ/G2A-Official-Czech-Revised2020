...
func void dia_skalven_3_standard_info()
{
	...
	if(randy == 0)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_00");	//(strach) Co po mnì chceš? Jdi pryè!
	};
	if(randy == 1)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_01");	//(nervóznì) Nic jsem neudìlal! Nech mì být!
	};
	if(randy == 2)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_02");	//(vystrašenì) Prosím, nebij mì!
	};
	AI_StopProcessInfos(self);
};
