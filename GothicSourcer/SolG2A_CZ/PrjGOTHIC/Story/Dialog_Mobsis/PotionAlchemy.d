...
instance PC_BOOZE_SCHNELLERHERING(C_INFO)
{
	...
	permanent = TRUE;
	description = "Namixuj 'Rychlého slaneèka'";
};
...
instance PC_ITPO_MANA_04(C_INFO)
{
	...
	permanent = TRUE;
	description = "lektvar many (3 esence many, 1 luèní pohanka)";
};
...
instance PC_HEALTH_START(C_INFO)
{
	...
	permanent = TRUE;
	description = "Namíchat leèívé lektvary";
};
...
instance PC_ITPO_HEALTH_04(C_INFO)
{
	...
	permanent = TRUE;
	description = "Léèivý lektvar (3 esence života, 1 luèní pohanka)";
};
...
instance PC_ITMI_ADDON_JOINT_01(C_INFO)
{
	...
	permanent = TRUE;
	description = "Udìlat zelného novice (2 stébla trávy z bažin, 1 luèní pohanka)";
};
