...
func void pc_goldhacken_addon_chance_info()
{
	...
	{
		concattext = ConcatStrings("tìžký zaèáteèník (",IntToString(HERO_HACKCHANCE));
	}
	else if(HERO_HACKCHANCE < 40)
	{
		concattext = ConcatStrings("slušný kopáè (",IntToString(HERO_HACKCHANCE));
	}
	else if(HERO_HACKCHANCE < 55)
	{
		concattext = ConcatStrings("velice dobrý kopáè (",IntToString(HERO_HACKCHANCE));
	}
	else if(HERO_HACKCHANCE < 75)
	{
		concattext = ConcatStrings("rozený kopáè ( ",IntToString(HERO_HACKCHANCE));
	}
	else if(HERO_HACKCHANCE < 90)
	{
		concattext = ConcatStrings("krutì dobrý kopáè ( ",IntToString(HERO_HACKCHANCE));
	}
	else if(HERO_HACKCHANCE < 98)
	{
		concattext = ConcatStrings("Pán kopáè ( ",IntToString(HERO_HACKCHANCE));
	}
	else
	{
