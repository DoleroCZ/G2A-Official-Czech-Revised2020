...
{
	AI_Output(other,self,"DIA_Addon_Wache_02_Hi_15_00");	//Vöechno v po¯·dku?
	AI_Output(self,other,"DIA_Addon_Wache_02_Hi_13_01");	//PoËkej chvÌli - nezn·me se odnÏkud?
	b_usefakescroll();
	AI_Output(self,other,"DIA_Addon_Wache_02_Hi_13_02");	//Hmmm..ne. Ty nejsi on. Ztraù se.
};
...
instance DIA_ADDON_WACHE_02_ATTENTAT(C_INFO)
{
	...
	permanent = FALSE;
	description = "Co vÌö o tom pokusu vraûdy?";
};
...
{
	AI_Output(other,self,"DIA_Addon_Wache_02_Attentat_15_00");	//Co vÌö o tom pokusu vraûdy?
	AI_Output(self,other,"DIA_Addon_Wache_02_Attentat_13_01");	//Co o tom vÌm? (SmÌch) Zlomil jsem mu obÏ nohy.
	AI_Output(self,other,"DIA_Addon_Wache_02_Attentat_13_02");	//(v˝hruûnÏ) a udÏl·m to komukoliv, kdo se chce dostat do potÌûÌ s Estebanem...
};
...
{
	AI_Output(other,self,"DIA_Addon_Wache_02_perm_15_00");	//NÏco novÈho?
	AI_Output(self,other,"DIA_Addon_Wache_02_perm_13_01");	//Vöude ticho.
	if(MIS_JUDAS == LOG_RUNNING)
	{
		AI_Output(self,other,"DIA_Addon_Wache_02_perm_13_02");	//Ty najdeö zr·dce - a pak se s nÌm vypo¯·d·me ...
	};
};
