...
{
	AI_Output(other,self,"DIA_Addon_Myxir_CITY_HelloCITY_15_00");	//Zùstaneš ve mìstì?
	AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_01");	//Jeden z nás tu musí zùstat, pokud Vatras odejde z mìsta.
	VATRASABLOESEISTDA = TRUE;
	if((RAVENISDEAD == TRUE) && (DIA_ADDON_MYXIR_CITY_HELLOCITY_ONETIME == FALSE))
	{
		AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_02");	//Ještì jedna vìc, co ti chci øíct.
		AI_Output(self,other,"DIA_Addon_Myxir_CITY_HelloCITY_12_03");	//Byl to pravý hrdinský èin, který jsi uèinil v Jharkendaru.
		AI_Output(other,self,"DIA_Addon_Myxir_CITY_HelloCITY_15_04");	//Bohužel jsem ještì nesplnil svùj úkol v Khorinisu.
