...
{
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_00");	//Je jen jedna cesta jak se dostat do našeho tábora živý - pøes most.
...
{
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_01");	//Øíkáš si o jednu do držky, co? Ještì JEDEN krok a poletíš ze skály dolù.
	other.aivar[AIV_LASTDISTTOWP] = Npc_GetDistToWP(other,BDT_1064_CHECKPOINT);
...
func void dia_bdt_1064_banditguard_attack_info()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexwache_Add_04_02");	//Dobrá, øekl sis o to ...
	AI_StopProcessInfos(self);
