...
func void dia_addon_monty_nw_hi_info()
{
	...
	AI_Output(self,other,"DIA_Addon_Monty_NW_Hi_08_01");	//Hejskové, nedali jediné prkno na správné místo, když jsem byl pryè. Budu se muset vrátit k rýsovacímu prknu a probrat to, co jsem zanechal.
	AI_Output(other,self,"DIA_Addon_Monty_NW_Hi_15_02");	//Jasnì. Nenech mì zdržet tì.
	AI_Output(self,other,"DIA_Addon_Monty_NW_Hi_08_03");	//(smìje se) Jasná vìc. Pøíjemnou cestu.
};
